...
- NOTE: To successfully perform this lab, a properly installed and configured Active Directory Domain is required with a working domain controller and at least one domain 
